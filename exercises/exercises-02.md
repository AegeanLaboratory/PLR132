...
Για να δείτε τη **ΛΥΣΗ** πατήστε [εδώ](source/exercise_2_01.c).
...
Για να δείτε τη **ΛΥΣΗ** πατήστε [εδώ](source/exercise_2_02.c).
...
Για να δείτε τη **ΛΥΣΗ** πατήστε [εδώ](source/exercise_2_03.c).

## Άσκηση 4

Να γραφεί πρόγραµµα που θα υπολογίζει το άθροισµα των κλασµάτων 1/1 + 1/2 +1/3 +1/4 + 1/5 + .. + 1/100.

Για να δείτε τη **ΛΥΣΗ** πατήστε [εδώ](source/exercise_2_04.c).
...
Για να δείτε τη **ΛΥΣΗ** πατήστε [εδώ](source/exercise_2_06.c).
...
Για να δείτε τη **ΛΥΣΗ** πατήστε [εδώ](source/exercise_2_08.c).
...
Για να δείτε τη **ΛΥΣΗ** πατήστε [εδώ](source/exercise_2_09.c).
